...
const SvgEye = ({ title, titleId, ...props }: SVGProps<SVGSVGElement> & SVGRProps) => (
  ...
  >
    ...
    <defs>
      ...
      <rect id="eye_svg__b" x={0} y={35} width={1060} height={123} rx={4} />
    </defs>
    <g fill="none" fillRule="evenodd">
      <path fill="#F6F9FC" d="M-130-2183h1200V340H-130z" />
      <g transform="translate(-30 -65)">
        <use fill="#000" filter="url(#eye_svg__a)" xlinkHref="#eye_svg__b" />
        <use fill="#FFF" xlinkHref="#eye_svg__b" />
      </g>
