...
export const icons = {
  ...
  trash: [
    <path d="M4.5 6c.28 0 .5.22.5.5v5a.5.5 0 0 1-1 0v-5c0-.28.22-.5.5-.5Zm5.5.5a.5.5 0 0 0-1 0v5a.5.5 0 0 0 1 0v-5ZM7 6c.28 0 .5.22.5.5v5a.5.5 0 0 1-1 0v-5c0-.28.22-.5.5-.5Z" />,
    <path
      fill-rule="evenodd"
      d="M5 0a.5.5 0 0 0-.5.5V2h-3a.5.5 0 0 0-.5.5v2c0 .28.22.5.5.5H2v7c0 1.1.9 2 2 2h6a2 2 0 0 0 2-2V5h.5a.5.5 0 0 0 .5-.5v-2a.5.5 0 0 0-.5-.5h-3V.5A.5.5 0 0 0 9 0H5Zm6 5v7a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5h8Zm1-1V3H2v1h10ZM8.5 1h-3v1h3V1Z"
    />,
  ],
  pinalt: (
