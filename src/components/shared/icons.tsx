...
export const icons = {
  ...
  linux: (
    <>
      <path
        fillRule="evenodd"
        d="M.86 8.98c.43.14 1.35.45 2.35.17l.08.26a2 2 0 1 0 2.97 2.54 5.2 5.2 0 0 0 1.48 0A2 2 0 1 0 10.7 9.4l.08-.26c1 .28 1.92-.03 2.35-.17h.01a.5.5 0 0 0 .35-.5.5.5 0 0 0-.06-.21A7.41 7.41 0 0 0 10.5 5.2V4.5a3.5 3.5 0 1 0-7 0v.7a7.27 7.27 0 0 0-.94.66A7.41 7.41 0 0 0 .54 8.3a.5.5 0 0 0 .31.67h.01ZM4.5 9a2 2 0 0 1 2 1.97 4.34 4.34 0 0 0 1 0 2 2 0 0 1 2.29-1.95c.12-.4.19-.83.2-1.28-.1-.08-.27-.18-.5-.28A5.07 5.07 0 0 0 8.3 7.1l-.02.02a5.83 5.83 0 0 1-.87.75A.89.89 0 0 1 7 8a.89.89 0 0 1-.41-.12 5.83 5.83 0 0 1-.88-.75l-.02-.02A5.07 5.07 0 0 0 4 7.74c.02.45.1.89.21 1.28L4.5 9Zm6 2a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-6 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2Zm1.94-5.55c-.26-.28-.53-.6-.72-.85a2.5 2.5 0 0 1 2.56 0c-.2.25-.46.57-.72.85a4.88 4.88 0 0 1-.56.52 4.88 4.88 0 0 1-.56-.52ZM6.5 4a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0Zm1.5.5a.5.5 0 1 0 0-1 .5.5 0 0 0 0 1Z"
      />
    </>
  ),
  ubuntu: (
    <>
      <path d="M11.51 2.77c0 .98-.76 1.77-1.7 1.77-.95 0-1.71-.79-1.71-1.77S8.86 1 9.8 1c.95 0 1.71.8 1.71 1.77ZM4.41 6.66c0 .98-.76 1.77-1.7 1.77-.95 0-1.71-.8-1.71-1.77 0-.98.76-1.77 1.7-1.77.95 0 1.71.79 1.71 1.77ZM6.55 11.22a4.08 4.08 0 0 1-2.83-2.25c-.46.22-.97.28-1.46.19.34.88.88 1.65 1.58 2.26a5.47 5.47 0 0 0 3.63 1.35 2.6 2.6 0 0 1-.5-1.48 4.09 4.09 0 0 1-.42-.07ZM11.13 11.23c0 .98-.77 1.77-1.7 1.77-.95 0-1.71-.8-1.71-1.77 0-.98.76-1.77 1.7-1.77s1.7.79 1.7 1.77ZM11.8 10.58a5.94 5.94 0 0 0 .27-6.8c-.2.48-.53.88-.96 1.16a4.48 4.48 0 0 1-.13 4.32c.4.34.68.8.81 1.32ZM2.7 4.11h-.13a5.55 5.55 0 0 1 5.3-2.91c-.32.41-.5.91-.53 1.43A4.03 4.03 0 0 0 4 4.5a2.4 2.4 0 0 0-1.3-.39Z" />
    </>
  ),
  windows: (
    <>
      <path
        fillRule="evenodd"
        d="M6.5 2H2v4.5h4.5V2ZM12 2H7.5v4.5H12V2ZM7.5 7.5H12V12H7.5V7.5Zm-1 0H2V12h4.5V7.5Z"
      />
    </>
  ),
  storybook: (
